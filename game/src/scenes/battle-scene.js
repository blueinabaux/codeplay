...
export class BattleScene extends Phaser.Scene {
  ...
  update() {
    ...
    const otherKeyPressed=Phaser.Input.Keyboard.JustDown(this.#cursorKeys.shift)
    ...
    if (wasSpaceKeyPressed) {
      this.#flag=this.#battleMenu.handlePlayerInput('OK');
      if(!otherKeyPressed){
    if(this.#flag){
      this.#playerAttack();
 }}
  ...
  #playerAttack() {
    this.#battleMenu.updateInfoPaneMessageNoInputRequired(
      `${this.#activePlayerMonster.name} used slash`,
      () => {
          ...
          this.#attackManager.playAttackAnimation(
            ...
            () => {
              this.#activeEnemyMonster.playTakeDamageAnimation(() => {
                this.#activeEnemyMonster.takeDamage(100, () => {
                  this.#enemyAttack();
                });
              });
            }
          ...
          this.#attackManager.playAttackAnimation(
            ...
            () => {
              this.#activePlayerMonster.playTakeDamageAnimation(() => {
                this.#activePlayerMonster.takeDamage(100, () => {
                  this.#battleStateMachine.setState(BATTLE_STATES.POST_ATTACK_CHECK);
                });
              });
            }
...
//       () => {
//         this.time.delayedCall(500, () => {
//           console.log(`${this.#activePlayerMonster.attacks[this.#activePlayerAttackIndex].animationName}`),
//           this.#attackManager.playAttackAnimation(
// 'SLASH',            ATTACK_TARGET.ENEMY,
//             () => {
//               this.#activeEnemyMonster.playTakeDamageAnimation(() => {
